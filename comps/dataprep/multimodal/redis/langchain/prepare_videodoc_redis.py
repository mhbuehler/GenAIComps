...
@register_microservice(
    name="opea_service@prepare_videodoc_redis", endpoint="/v1/generate_transcripts", host="0.0.0.0", port=os.getenv("REDIS_RETREIEVER_PORT", 6007)
)
...
@register_microservice(
    name="opea_service@prepare_videodoc_redis", endpoint="/v1/generate_captions", host="0.0.0.0", port=os.getenv("REDIS_RETREIEVER_PORT", 6007)
)
...
@register_microservice(
    ...
    host="0.0.0.0",
    port=os.getenv("REDIS_RETREIEVER_PORT", 6007),
)
...
@register_microservice(
    name="opea_service@prepare_videodoc_redis", endpoint="/v1/dataprep/get_files", host="0.0.0.0", port=os.getenv("REDIS_RETREIEVER_PORT", 6007)
)
...
@register_microservice(
    name="opea_service@prepare_videodoc_redis", endpoint="/v1/dataprep/delete_files", host="0.0.0.0", port=os.getenv("REDIS_RETREIEVER_PORT", 6007)
)
